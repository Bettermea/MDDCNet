...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT + '/ultralytics/cfg/datasets/KITTI.yaml', help='dataset.yaml path')
    parser.add_argument('--config', type=str, default=ROOT + '/ultralytics/cfg/models/MDDCNet/MDDCNet-T.yaml', help='model path(s)')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=640, help='inference size (pixels)')
    parser.add_argument('--task', default='train', help='train, val, test, speed or study')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--workers', type=int, default=28, help='max dataloader workers (per RANK in DDP mode)')
    ...
    parser.add_argument('--name', default='MDDCNet', help='save to project/name')
